...
This template uses [Better Auth](https://www.better-auth.com/) via [`@nuxtjs/better-auth`](https://better-auth.nuxt.dev) for authentication with email and password enabled by default.
